    ...
    <Card className="h-full flex flex-col rounded-3xl border-white/60 bg-white/70 backdrop-blur overflow-hidden">
      <CardHeader className="shrink-0 md:px-vp md:py-vg">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 md:gap-vs rounded-full border border-black/5 bg-white/60 px-2 md:px-3 py-0.5 md:py-1 text-base md:text-v-base">
        ...
        <div className="grid grid-cols-[90px_1fr] sm:grid-cols-[100px_1fr] md:grid-cols-[clamp(120px,12vw,220px)_1fr] gap-3 md:gap-vg h-full">
          ...
          <div className="flex flex-col justify-between h-full min-w-0">
            <div className="space-y-1.5 md:space-y-vs">
              <p className="text-xl sm:text-2xl md:text-v-lg font-semibold leading-tight">
              ...
              <div className="space-y-0.5">
                <p className="text-lg md:text-v-lg font-medium">
                  BUT MMI · 3ᵉ année
                </p>
              ...
              <div className="flex flex-wrap gap-1.5 md:gap-vs pt-1 md:pt-vs">
                <span className="rounded-full bg-black/5 px-2 sm:px-2.5 md:px-3 py-1 md:py-vs text-sm sm:text-base md:text-v-base font-medium">
                  Alternance · Altermaker
                </span>
                <span className="rounded-full bg-black/5 px-2 sm:px-2.5 md:px-3 py-1 md:py-vs text-sm sm:text-base md:text-v-base text-muted-foreground">
            ...
            <div className="pt-2 md:pt-vs">
              <Button
                asChild
                size="default"
                className="h-10 md:h-vbtn w-full rounded-full text-lg md:text-v-lg border-0 shadow-none"
              >
                <Link
